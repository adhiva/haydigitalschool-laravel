...
<head>
    ...
    <title>Hay Digital School x SMK Informatika Utama</title>
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html">Hay Digital School Project</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="getstarted scrollto" href="{{ backpack_url('login'); }}">Login</a></li>
                </ul>
        ...
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 text-center">
                    <h1>Hay Digital School</h1>
                    <h1>X</h1>
                    <h1>SMK Informatika Utama</h1>
                </div>
            </div>
            <div class="text-center">
                <a href="#about" class="btn-get-started scrollto">Laravel Class</a>
            </div>
            ...
            <div class="row icon-boxes">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Laravel Life Cycle</a></h4>
                        <p class="description">Basic knowledge about Laravel Framework and How to use it!</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">User Management</a></h4>
                        <p class="description">Basic knowledge CRUD about User at Web Application!</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Roles Management</a></h4>
                        <p class="description">Basic knowledge CRUD about Role and attach it to user!</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Permissions Management</a></h4>
                        <p class="description">Basic knowledge CRUD about Permission and attach it to Role or User!</p>
                    </div>
                </div>
            ...
            <div class="row icon-boxes">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <p class="description">Basic knowledge CRUD about Product and manage it using Role and User Permission!</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Final Project</a></h4>
                        <p class="description">Basic project to be ready to work in a Startup Company</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>What we Do ? </h2>
                    <p>Learn about real case project at Company, using Laravel Framework</p>
                </div>
    ...
    <footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        <h3>Hay Digital School</h3>
                        <p>
                            A108 Adam Street <br>
                            New York, NY 535022<br>
                            United States <br><br>
                            <strong>Email:</strong> contact@haydigitalschool.com<br>
                        </p>
                    </div>
        ...
        <div class="container d-md-flex py-4">
            ...
            <div class="me-md-auto text-center text-md-start">
                <div class="copyright">
                    &copy; Copyright <strong><span>Hay Digital School</span></strong>. All Rights Reserved
                </div>
            </div>
